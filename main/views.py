...
from main.models import Size, Category, ClothingItem
...
class CatalogView(ListView):
    ...
    def get_queryset(self):
        ...
        if size_names:
            queryset = queryset.filter(
                Q(size__name__in=size_names) & Q(sizes__clothing_items__available=True)
            )
    ...
    def get_context_data(self, **kwargs):
        ...
        context["min_price"] = self.request.GET.get("min-price", '')
        context["max_price"] = self.request.GET.get("max-price", '')
